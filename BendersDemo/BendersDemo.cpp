...
main(int argc, char** argv) {
	...
	try {
		const char* fileName = "data/atsp.dat";

		//FALSE: Indicates that Benders' cuts are only used as lazy constraints to separate integer infeasible solutions.
		//TRUE: Indicates that Benders' cuts are also used as user cuts to separate fractional infeasible solutions.
		IloBool separateFracSols = false;
